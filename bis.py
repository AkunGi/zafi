...
'pass':pw
    ...
    'viewport-width': '980',
			...
			po = ses.post('https://mbasic.facebook.com/login.php?next=https%3A%2F%2Fmbasic.facebook.com%2Fmenu%2Fbookmarks%2F%3Fref_component%3Dmbasic_home_header%26ref_page%3D%252Fwap%252Fhome.php%26refid%3D7%26paipv%3D0%26eav%3DAfblb3EYPwfbB5qLllz1E7yOk4qKFOgNkobIiJRpVrn11bF1ihV_xP1--qhIt0Aw5b4&refsrc=deprecated&wtsid=rdr_06hvcGozIogghflZs&ref_component=mbasic_home_header&_rdr',
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'no' in gabriel:
					cp+=1
					print('\n')
